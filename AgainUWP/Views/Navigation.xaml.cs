...
namespace AgainUWP.Views
{
    ...
    public sealed partial class Navigation : Page
    {
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _pages.Add(("content", typeof(ListViewDemo)));
        ...
        private async void IsLogin()
        {
            ...
            if (text != "")
            {
                ...
                if (token != "")
                {
                    ...
                    _pages.Add(("account", typeof(Account)));
                }
            }
            else
            {
                try
                {
                    var exitsAccount = this.FindName("account1") as NavigationViewItem;
                    NavView.MenuItems.Remove(exitsAccount);
                }
                catch
                {
        ...
        private void Do_Refresh(object sender, RoutedEventArgs e)
        {
            Frame rootFrame = Window.Current.Content as Frame;
            rootFrame.Navigate(typeof(Views.Navigation));
        }

        private async void Do_SignUp(object sender, TappedRoutedEventArgs e)
        {
            string text = await APIHandle.CheckCredential();
            if (text != "")
            {
        ...
        private async void Do_SignIn(object sender, TappedRoutedEventArgs e)
        {
            string text = await APIHandle.CheckCredential();
            if (text != "")
            {
        ...
        private void account_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            //NavView.Header = navigationViewItem.Tag;
        }
    }
}
